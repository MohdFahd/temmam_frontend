(function () {
  ...
  var e = {
      7442: function (e, t, s) {
        var l = s(9242),
          a = s(3396);
        function r(e, t, s, l, r, n) {
          const o = (0, a.up)("header-one"),
            i = (0, a.up)("router-view"),
            c = (0, a.up)("FooterPage");
          return (
            (0, a.wg)(),
            (0, a.iD)(
        ...
        const n = {
          ...
          i = [o];
        function c(e, t, s, l, r, o) {
          return (0, a.wg)(), (0, a.iD)("footer", n, i);
        }
        ...
        var x = u,
          ...
          f = s(9245);
        const v = (e) => (
            (0, a.dD)("data-v-136109fd"), (e = e()), (0, a.Cn)(), e
          ),
          h = v(() => (0, a._)("img", { src: "", alt: "" }, null, -1)),
          w = { class: "hidden lg:block" },
          C = { class: "space-x-8 text-xl text-center", "aria-label": "main" },
          b = v(() =>
            (0, a._)(
              "a",
              {
          ...
          k = v(() => (0, a._)("h1", null, "Home", -1)),
          F = v(() => (0, a._)("h1", null, "Call Center", -1)),
          P = v(() => (0, a._)("h1", null, "Services", -1)),
          A = v(() => (0, a._)("h1", null, "Contact Us", -1));
        var W = {
          __name: "HeaderOne",
          setup(e) {
            return (e, t) => {
        ...
        const j = (0, m.Z)(W, [["__scopeId", "data-v-136109fd"]]);
        var D = j,
          I = { components: { HeaderOne: D, FooterPage: x } };
        const U = (0, m.Z)(I, [["render", r]]);
        var H = U,
          E = s(2483);
        const O = { class: "home" };
        function B(e, t, s, l, r, n) {
          const o = (0, a.up)("MainPage");
          return (0, a.wg)(), (0, a.iD)("div", O, [(0, a.Wm)(o)]);
        }
        function q(e, t, s, l, r, n) {
          const o = (0, a.up)("HomeSection"),
            i = (0, a.up)("CallCenter"),
            c = (0, a.up)("AboutSection"),
            d = (0, a.up)("Services"),
            m = (0, a.up)("Projects"),
            u = (0, a.up)("Testimonial"),
            x = (0, a.up)("Our_Clients");
          return (
            (0, a.wg)(),
            (0, a.iD)("main", null, [
              (0, a.Wm)(o),
        ...
        function $(e, t, s, l, r, n) {
          const o = (0, a.up)("Button");
          return (
            (0, a.wg)(),
            (0, a.iD)("section", Z, [
              (0, a._)("div", z, [
                ...
                M,
                T,
                (0, a.Wm)(o, { text: r.text }, null, 8, ["text"]),
              ]),
              V,
            ])
          );
        }
        function K(e, t, s, l, r, n) {
          return (
            (0, a.wg)(),
            (0, a.iD)(
              "button",
        ...
        function ae(e, t, s, l, r, n) {
          const o = (0, a.up)("Card"),
            i = (0, a.up)("router-link");
          return (
            (0, a.wg)(),
            (0, a.iD)("section", X, [
              ee,
        ...
        const re = ["src"],
          ne = { class: "text-xl py-3 font-extrabold" },
          oe = { class: "text-lg font-normal" };
        function ie(e, t, s, l, r, n) {
          return (
            (0, a.wg)(),
            (0, a.iD)(
              "div",
              ...
              [
                ...
                (0, a._)("div", null, [
                  (0, a._)("h2", ne, (0, g.zw)(s.Contents.title), 1),
                  (0, a._)("p", oe, (0, g.zw)(s.Contents.desc), 1),
                ]),
              ],
              2
            )
        ...
        const ge = {
          ...
          ve = (0, a._)(
            "div",
            { class: "w-[90%]" },
            [(0, a._)("img", { src: "assets/imgs/main.svg", wi: "", alt: "" })],
            -1
          ),
          he = [fe, ve];
        function we(e, t, s, l, r, n) {
          return (0, a.wg)(), (0, a.iD)("section", ge, he);
        }
        var Ce = { name: "AboutSection" };
        const be = (0, m.Z)(Ce, [["render", we]]);
        var _e = be;
        const ye = {
            class: "flex justify-between items-center flex-wrap lg:flex-nowrap",
            id: "Services",
          },
          Se = { class: "flex flex-col w-[100%] sm:p-20 p-5" },
          ke = (0, a._)(
            "h6",
            { class: "text-xl py-3 text-[#F3AF1C]" },
            "Our Services",
          ...
          Ae = { class: "grid sm:grid-cols-2 grid-cols-1 gap-6 p-5" };
        function We(e, t, s, l, r, n) {
          const o = (0, a.up)("Button"),
            i = (0, a.up)("router-link"),
            c = (0, a.up)("Card");
        ...
        const De = (0, m.Z)(je, [["render", We]]);
        var Ie = De;
        const Ue = { id: "Projects" },
          He = (0, a._)(
            "h5",
          ...
          Be = { class: "block lg:hidden" };
        function qe(e, t, s, l, r, n) {
          const o = (0, a.up)("Card");
          return (
            (0, a.wg)(),
            (0, a.iD)("section", Ue, [
        ...
        const ze = (0, m.Z)(Ze, [["render", qe]]);
        var Ye = ze;
        const Me = (e) => (
            (0, a.dD)("data-v-2ffc05d4"), (e = e()), (0, a.Cn)(), e
          ),
          Te = {
            class:
          ...
          Le = { class: "px-3 font-bold" },
          Qe = { class: "px-3" },
          Je = { class: "flex items-end justify-end" },
          Ne = Me(() =>
            (0, a._)(
              "img",
              {
                    ...
                    (0, a.Ko)(
                      ...
                      (e, t) => (
                        ...
                        (0, a.iD)(
                          ...
                          [
                            (0, a._)("p", Re, (0, g.zw)(e.Paragraph), 1),
                            (0, a._)("h1", Le, (0, g.zw)(e.author), 1),
                            (0, a._)("h1", Qe, (0, g.zw)(e.job), 1),
                          ],
                          2
                        )
                      )
        ...
        const nt = (0, a._)(
          ...
          ot = { class: "flex justify-center my-10 rounded text-white" },
          it = (0, a._)(
            "img",
            {
        ...
        function gt(e, t, s, l, r, n) {
          const o = (0, a.up)("swiper-slide"),
            i = (0, a.up)("swiper");
          return (
            (0, a.wg)(),
            (0, a.iD)(
        ...
        var ft = s(4528),
          vt = s(1569),
          ht = {
            components: { Swiper: ft.tq, SwiperSlide: ft.o5 },
            setup() {
              return { modules: [vt.W_] };
            },
            data() {
              return {
        ...
        const _t = (0, m.Z)(bt, [["render", q]]);
        var yt = _t,
          St = {
            name: "HomeView",
            components: { HeaderOne: D, MainPage: yt, FooterPage: x },
          };
        const kt = (0, m.Z)(St, [["render", B]]);
        var Ft = kt;
        const Pt = { key: 0 },
          At = {
            class:
          ...
          Wt = { class: "container w-[100%] sm:mx-10" },
          jt = (0, a._)(
            "h6",
            { class: "text-xl py-3 text-[#F3AF1C]" },
            "call center system",
          ...
          Dt = { class: "sm:text-4xl text-4xl font-bold text-[#0F113C]" },
          It = { class: "text-lg py-3 text-gray-600" },
          Ut = (0, a._)(
            "div",
                ...
                ? ((0, a.wg)(),
                  (0, a.iD)("div", Pt, [
                    (0, a._)("section", At, [
                      (0, a._)("div", Wt, [
                        jt,
                        (0, a._)("h1", Dt, (0, g.zw)(r.Service.title), 1),
                        (0, a._)("p", It, (0, g.zw)(r.Service.paragraph), 1),
                      ]),
                      Ut,
                    ]),
                    Ht,
                  ]))
                : ((0, a.wg)(), (0, a.iD)("div", Et, " Data not found ")),
            ])
          );
        }
        var Bt = {
          ...
          props: ["id"],
          data() {
            return { Class: "bg-[#F3AF1C] rounded-full", Service: null };
          },
          beforeRouteEnter(e, t, s) {
            fetch("http://localhost:3000/CallCenter?id=" + e.params.id)
              .then((e) => e.json())
              .then((e) => {
                s((t) => {
                  t.Service = e[0];
          ...
          return (
            ...
            (0, a.iD)("section", zt, [
              ...
              (0, a._)("div", Mt, [
                ...
                Vt,
                $t,
                (0, a.Wm)(o, { class: (0, g.C_)(r.Class) }, null, 8, ["class"]),
              ]),
            ])
          );
        }
        ...
        const ss = (0, m.Z)(ts, [["render", es]]);
        var ls = ss;
        const as = [
            { path: "/", name: "home", component: Ft },
            {
              path: "/callcenter/:id",
              name: "CallCenter",
              component: Zt,
            ...
            { path: "/ContactUs", name: "ContactUs", component: Qt, props: !0 },
            { path: "/Services", name: "Services", component: ls, props: !0 },
          ],
          rs = (0, E.p7)({ history: (0, E.PO)("/"), routes: as });
        var ns = rs,
          os = s(65),
          is = (0, os.MT)({
            state: {},
        ...
        (0, l.ri)(H).use(is).use(ns).mount("#app");
      },
    },
    t = {};
  function s(l) {
    ...
    var r = (t[l] = { exports: {} });
    return e[l].call(r.exports, r, r.exports, s), r.exports;
  }
  (s.m = e),
    (function () {
      var e = [];
      s.O = function (t, l, a, r) {
        if (!l) {
          var n = 1 / 0;
          for (d = 0; d < e.length; d++) {
            (l = e[d][0]), (a = e[d][1]), (r = e[d][2]);
    ...
    (function () {
      ...
      var t = function (t, l) {
          ...
          for (t && t(l); c < n.length; c++)
            (r = n[c]), s.o(e, r) && e[r] && e[r][0](), (e[r] = 0);
          return s.O(d);
        },
...
//# sourceMappingURL=app.26e9dc2d.js.map
